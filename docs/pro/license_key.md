...
For more details, see Step 2 under [1-click installer](release.md#1-click-installerembedded-code).
...
* Paste the deploy key in your `xlwings.conf` sheet as value for `LICENSE_KEY`, see [xlwings.conf Sheet](../addin.md#workbook-config-xlwingsconf-sheet)
