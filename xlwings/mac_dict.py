...
Compatible terminology additions and corrected enum values from newer Excel SDEFs are merged selectively so the aliases and command parameters required by xlwings remain.

Usage:
See scripts/build_mac_dict.py for current build script.
...
commands = [
    ...
    (
        "duplicate",
        b"coreclon",
        [("to", b"insh"), ("with_properties", b"prdt")],
    ),
    (
        "error_bar",
        b"sCRT2299",
