...
def set_hyperlink(xl_range, address = None, text2display = None, screen_tip = 'Link'):
    if text2display == None:
        xl_range.Hyperlinks.Add(Anchor = xl_range, Address = address,
                                TextToDisplay = address, ScreenTip = screen_tip)    
    else:
        xl_range.Hyperlinks.Add(Anchor = xl_range, Address = address,
